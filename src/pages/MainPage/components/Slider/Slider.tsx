    ...
    return (
        <div className="slider">
            ...
            <div className="slider__arrows">
                <div className="slider__arrows_left" data-change="-1" onClick={handlerChangeSlide}> <div className="slider__arrow__left"><ChevronLeft/></div> </div>
                <div className="slider-content">
                    <CurrentSlide title={SliderElems[active].title} text={SliderElems[active].text} colorButton={SliderElems[active].colorButton}/>
                    <ActiveDots active={active} onClick={handlerChangeActiveDot}/>
                </div>
                <div className="slider__arrows_right" data-change="1" onClick={handlerChangeSlide}> <div className="slider__arrow__right"><ChevronRight/></div></div>
            </div>
        </div>
    )
}
