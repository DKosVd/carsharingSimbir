...
import {
  ClearPointsByCityAction,
  FetchPointsAction,
} from "../../../../store/actions/point/point";
    ...
    <>
        ...
        <form className="order-form">
          <div className="order-form__elem order-form__elem_mb">
            <div className="optional-wrapper order-form__elem_layout order-input-wrapper">
              ...
              <CreatableSelect
                className="underline order-form__elem_ml order-input"
                value={cities?.filter((el) => {
      ...
      <div className="order-city">
        ...
        <div className="order__city__img">
          <Map
            query={cityPlace?.city?.name}
            place={`${cityPlace?.address?.name}, ${cityPlace?.address?.address}`}
          />
        </div>
      </div>
    </>
